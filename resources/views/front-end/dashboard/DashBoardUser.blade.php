...
<body>
	<div class="page-container">
		...
		<div class="sidebar-menu">
			...
			<div class="menu">
				<ul id="menu">
					<li><a href="{{route('WriteStroies')}}"><i class="fa fa-file-text"></i><span>Write Story</span></a></li>
					<li><a href="{{route('MyStroies')}}"><i class="fa fa-file-text"></i><span>My Story</span></a></li>
				</ul>
			</div>
		</div>
		<div class="clearfix"></div>
